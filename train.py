...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5_poppy.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='poppy.yaml', help='data.yaml path')
